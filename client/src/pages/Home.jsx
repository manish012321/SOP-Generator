      ...
      <div className="max-w-7xl mx-auto px-6 lg:px-16 py-10 flex flex-col lg:flex-row items-center justify-between gap-12">
        ...
        <div className="w-full lg:w-1/2">
          ...
          <div className="flex flex-wrap gap-4 mt-8">
            ...
            <button
            onClick={showMessage}
            className="flex items-center bg-white border border-gray-200 hover:border-purple-300 text-gray-800 font-semibold px-6 py-4 rounded-xl shadow-sm hover:scale-105 transition-all duration-300">
            ...
            <div className="flex-1">
              ...
              <div className="space-y-3">
                <div>
                  ...
                  />
                  <p className="text-xs text-gray-400 text-right mt-1">/500</p>
                </div>
              </div>
            ...
            <div className="flex-1 flex flex-col">
              ...
              <div className="flex-1 space-y-2 overflow-y-auto max-h-64">
                ...
                {/* SOP Steps */}
                  ...
                  <div className="space-y-3">
                    <h3 className="font-bold text-purple-700 text-sm"></h3>
              ...
              <button 
              onClick={showMessage}
              className="w-full mt-4 border border-gray-200 hover:border-purple-300 text-gray-700 font-medium py-2.5 rounded-xl text-sm flex items-center justify-center gap-2 transition-all">
